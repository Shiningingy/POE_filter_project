# [parsing_tool group D: SPENT ONE-SHOT, 2026-01-13] Already applied to the tree.
# Re-running reverts that region to its 2026-01-13 state and destroys curation done
